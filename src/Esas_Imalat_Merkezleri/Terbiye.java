...
public class Terbiye extends Esas_Imalat_Merkezleri {
	
	public Terbiye() {
		initializeVariables();
	}
	private void initializeVariables(){
	    String searchQuery="SELECT ID,Hazirlik_Suresi,St_Calisma_Suresi,Saat_Ucreti,St_Uretim_Miktari,Prim_Orani FROM terbiye";
		ResultSet rSet=null;
		try {
	...
	public String toString(){
		 String value ="Terbiye";
		 return value;
	 }
	@Override
	public void bilgileriGoster(){
		System.out.println("Ýmalat Hazýrlýk Süresi : " + getHazirlikSuresi()+ " Dakikadýr." );
	...
	public static void TerbiyeSabitleriDegistir(Scanner s){
		int secim;
		...
		try {
			...
			case 1:
				...
				String updateQuery="UPDATE terbiye "+ "SET Hazirlik_Suresi = '"+hs +"' WHERE ID='SABIT'";
			...
			case 2:
				...
				String updateQuery2="UPDATE terbiye "+ "SET St_Calisma_Suresi = '"+stz +"' WHERE ID='SABIT'";
			...
			case 3:
				...
				String updateQuery3="UPDATE terbiye "+ "SET Saat_Ucreti = '"+ucret +"' WHERE ID='SABIT'";
			...
			case 4:
				...
				int süm=s.nextInt();
				String updateQuery4="UPDATE terbiye "+ "SET St_Uretim_Miktari = '"+süm +"' WHERE ID='SABIT'";
			...
			case 5:
				...
				String updateQuery5="UPDATE terbiye "+ "SET Prim_Orani = '"+po +"' WHERE ID='SABIT'";
			...
			e.printStackTrace();
			System.out.println("\n-------------------------------------------------------");
			System.out.println("Hatalý veri giriþi algýlandý. Lütfen tekrar deneyin.");
			s.next();
			TerbiyeSabitleriDegistir(s);
		}
	}
